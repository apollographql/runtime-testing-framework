...
As outlined in the [Test Plan][0] overview, your Environment configuration is
one of the two main pieces of configuration needed in order to run tests under
RTF. Conceptually, an Environment configuration is a pair of [Command providers][1]
that are run either side of the test scenario you want to run in order to setup and teardown the
resources required for running the test.

In this page we will cover the available keys within an Environment and outline the structure

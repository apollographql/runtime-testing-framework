...
with fields that serve as inputs to business logic from the [rtf-integrations][1] crate. Running a
file provider will generate one or more resources within a user designated output directory which
can then be referenced by the commands being run as part of a test plan.
...
[1]: https://github.com/apollographql/runtime-testing-framework/tree/37ed7a5f57c7761ee24acc1a0ece82fc5456740d/crates/rtf-integrations

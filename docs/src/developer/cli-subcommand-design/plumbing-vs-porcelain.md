...
The porcelain commands expose full end-to-end functionality to the users. They can be thought of as pipelines running the functionality in the plumbing commands sequentially to acheive the user's desired outcome.

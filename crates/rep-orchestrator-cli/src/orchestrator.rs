...
pub trait Client: Send + Sync {
    ...
    fn update_error_status(
        ...
        self.update_status(Status::Unrunnable, None, Some(error.to_string()))
    }
...
mod tests {
    use super::*;
    use crate::{
        context::{FsError, FsErrorKind},
        orchestrator::mocks::MockClient,
    };
    ...
    async fn update_error_status_delegates_unrunnable_error() {
        ...
        let error = error::Error::from(FsError {

...
pub fn derive(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let (ident, required_variables, validate_context, try_template) =
...
impl InputMeta {
    ...
    fn into_token_streams(self) -> Result<(Ident, TokenStream, TokenStream, TokenStream)> {
        let (required_variables, validate_context, try_template) = match self.data {
...
fn struct_token_streams(field_meta: Vec<FieldMeta>) -> (TokenStream, TokenStream, TokenStream) {
    ...
    (required_variables, validate_context, try_template)
}
...
fn enum_token_streams(
    ...
    Ok((required_variables, validate_context, try_template))
}

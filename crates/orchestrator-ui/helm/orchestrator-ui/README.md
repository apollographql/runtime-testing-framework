...
| image            | object | `{"pullPolicy":"IfNotPresent","repository":"us-central1-docker.pkg.dev/platform-cross-environment/apollo-private-docker/orchestrator-ui","tag":null}` | Container image configuration                                  |
| image.pullPolicy | string | `"IfNotPresent"`                                                                                                                                      | Image pull policy                                              |
| image.repository | string | `"us-central1-docker.pkg.dev/platform-cross-environment/apollo-private-docker/orchestrator-ui"`                                                       | Image repository                                               |
...
| resources        | object | `{}`                                                                                                                                                  | Resource requests and limits for the orchestrator-ui container |

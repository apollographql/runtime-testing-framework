_rtf() {
    ...
    do
        case "${cmd},${i}" in
            ...
            rtf,custom-provider-check)
                cmd="rtf__custom__provider__check"
                ;;
            ...
            rtf,template)
                cmd="rtf__template"
                ;;
            rtf__help,custom-provider-check)
                cmd="rtf__help__custom__provider__check"
                ;;
            rtf__help,custom-provider-run)
    ...
    case "${cmd}" in
        rtf)
            opts="-v -h --var --vars --verbose --help run expand-matrix template custom-provider-check custom-provider-run help"
            ...
            return 0
            ;;
        rtf__custom__provider__check)
            opts="-v -h --var --vars --verbose --help <DEFINITION_PATH>"
        ...
        rtf__expand__matrix)
            ...
            ;;
        rtf__help)
            opts="run expand-matrix template custom-provider-check custom-provider-run help"
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
            ...
            return 0
            ;;
        rtf__help__custom__provider__check)
            opts=""
